...
## Project Structure
    ...
    ├── test_app_data_captu_38099  # Django project configurations
...
1. Clone this repo and `cd test_app_data_captu_38099`
...
2. Clone this repo and `cd test_app_data_captu_38099`
